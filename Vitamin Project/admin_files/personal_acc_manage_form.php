...
<main class="products_row">
    <div class="products_column">
        <?php if ($pwd_change_attempt !== NULL) {

            echo '<h3 style="color:red;">Password Change Failed. Old Password does not match records.</h3>';

        } ?>


        <h1>Edit/Update Account Information</h1>

        <form action="vitimins_worker.php" method="post" name="admin_update_acc_form" onsubmit="return validateAccountUpdate()">
            ...
            <input type="password" name="old_password" size="30" maxlength="128" />
            <br>

            <label>New Password: </label>
            <input type="password" name="new_password" size="30" maxlength="128" />
            <br>

            <label>Confirm New Password: </label>
            <input type="password" name="confirm_password" size="30" maxlength="128" />
            <br>
